...
public class MainActivity_0 extends AppCompatActivity {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.id_changing_language) {
            Toast.makeText(MainActivity_0.this, "Moving to English version", Toast.LENGTH_LONG).show();
            startActivity(new Intent(MainActivity_0.this, StartGameEn.class));
            return true;
        }
        switch(id){
            case R.id.id_about_using:
                Toast.makeText(MainActivity_0.this, "Instruction", Toast.LENGTH_LONG).show();
                return true;
