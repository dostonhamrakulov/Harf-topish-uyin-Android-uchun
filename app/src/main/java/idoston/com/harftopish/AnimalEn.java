...
public class AnimalEn extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_animal_en);


        image = (ImageView)findViewById(R.id.id_image_en);

        radioGroup = (RadioGroup) findViewById(R.id.id_radio_g_en);
        ani_1 = (RadioButton) findViewById(R.id.id_ani_1_en);
        ani_2 = (RadioButton) findViewById(R.id.id_ani_2_en);
        ani_3 = (RadioButton) findViewById(R.id.id_ani_3_en);
        ani_4 = (RadioButton) findViewById(R.id.id_ani_4_en);

        scoring = (TextView) findViewById(R.id.text_d_1_en);
    ...
    public void Finishing_animal(View view){
        Exit_alert();
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.id_changing_language) {
            Toast.makeText(AnimalEn.this, "Moving to English version", Toast.LENGTH_LONG).show();
            return true;
        }
        switch(id){
            case R.id.id_about_using:
                Toast.makeText(AnimalEn.this, "Instruction", Toast.LENGTH_LONG).show();
                return true;
